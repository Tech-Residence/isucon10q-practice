...
var (
	estateDB                  *sqlx.DB
	chairDB                   *sqlx.DB
	mySQLConnectionEstateData *MySQLConnectionEnv
	mySQLConnectionChairData  *MySQLConnectionEnv
...
func NewMySQLConnectionEstateEnv() *MySQLConnectionEnv {
	return &MySQLConnectionEnv{
		Host:     getEnv("ESTATE_MYSQL_HOST", "127.0.0.1"),
		Port:     getEnv("ESTATE_MYSQL_PORT", "3306"),
		User:     getEnv("ESTATE_MYSQL_USER", "isucon"),
		DBName:   getEnv("ESTATE_MYSQL_DBNAME", "estate"),
		Password: getEnv("ESTATE_MYSQL_PASS", "isucon"),
	}
}
...
func NewMySQLConnectionChairEnv() *MySQLConnectionEnv {
	return &MySQLConnectionEnv{
		...
		Port:     getEnv("CHAIR_MYSQL_PORT", "3306"),
		User:     getEnv("CHAIR_MYSQL_USER", "isucon"),
		DBName:   getEnv("CHAIR_MYSQL_DBNAME", "chair"),
		Password: getEnv("CHAIR_MYSQL_PASS", "isucon"),
	}
}
...
func main() {
	...
	mySQLConnectionEstateData = NewMySQLConnectionEstateEnv()
...
func initialize(c echo.Context) error {
	...
	estatePaths := []string{
		filepath.Join(sqlDir, "01_EstateSchema.sql"),
		filepath.Join(sqlDir, "1_DummyEstateData.sql"),
	}
	chairPaths := []string{
		filepath.Join(sqlDir, "02_ChairSchema.sql"),
